        ...
        <>
          ...
          <Media greaterThanOrEqual="md" className="h-full flex-1">
            <Table
              ...
              className="h-full [&_td]:border-2 [&_th]:border-2 dark:[&_th]:dark:bg-dsecondary [&_thead]:sticky dark:[&_.ant-table-container]:border-dborder dark:[&_th]:border-dborder [&_th]:border-2 [&_td]:border-2 dark:[&_td]:border-dborder [&_thead]:top-[109px] [&_thead]:z-[1]"
            />
          </Media>
        </>
      ) : null}
